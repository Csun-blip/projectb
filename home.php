...
<body class="tm-gray-bg">
		...
		<div class="flexslider flexslider-banner">
			<ul class="slides">
				...
				<li>
					...
					<img src="img/banner-03.png" alt="Image" />
				</li>
			</ul>
		</div>
	</section>
						...
						<div role="tabpanel" class="tab-pane fade tm-white-bg" id="car">
							<div class="tm-search-box effect2">
								<form action="#" method="post" class="hotel-search-form">
									...
									<div class="form-group tm-yellow-gradient-bg text-center">
										<button type="submit" name="submit" class="tm-yellow-btn">Coming soon!</button>
									</div>
								</form>
							</div>
						</div>
			...
			<div class="row">
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6">
						<h2 class="tm-section-title">Hotel in patan</h2>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3">
						<hr>
					</div>
				...
				?>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
						<div class="tm-home-box-2">
							...
							<p class="tm">NPR-2000 per Night</p>
					...
					<div class="col-md-5">
						...
						<div class="tm-home-box-3">
							...
							<div class="tm-home-box-3-info">
								...
								<div class="tm-home-box-2-container">
									<a href="#" class="tm-home-box-2-link">See More!</a>
								</div>
							</div>
						</div>
					</div>
	...
	<footer class="tm-black-bg">
		<div class="container">
			<div class="row">
				<p class="tm-copyright-text">Copyright &copy; 2021 Sishan
