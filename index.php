...
-->
  ...
  <body class="tm-gray-bg">
  		...
  		<div class="container">
  			<div class="row">
  				<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
  					<a href="index.php" class="tm-site-name">BookIt!</a>	
  				</div>
		  ...
		  <ul class="slides">
		    <li>
			    <div class="tm-banner-inner">
					<h1 class="tm-banner-title">Let's<span class="tm-yellow-text">BOOK</span>It!</h1>
					<p class="tm-banner-subtitle">Making guest happy makes us happy!</p>
					<a href="#hotel" class="tm-banner-link">Learn More</a>	
				</div>
				<img src="images/demo_1.jpg" alt="Image" />	
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		...
		<div class="row">
				...
				<div class="tm-home-box-1">
					<ul class="nav nav-tabs tm-white-bg" role="tablist" id="hotelCarTabs">
					    ...
					    <li role="presentation">
					    	<a href="#car" aria-controls="car" role="tab" data-toggle="tab">Restaurant</a>
					    </li>
					</ul>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-center">
					<img src="images/Hotels/goodwill.jpg" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-right">
					<img src="images/Hotels/Kutumba.jpg" alt="image" class="img-responsive">
					<a href="#">
						<div class="tm-red-gradient-bg tm-city-price-container">
							<span>Hotel Kutumba</span>
							<span>NPR 3,500</span>
						</div>	
					</a>					
				</div>				
	...
	<footer class="tm-black-bg">
		<div class="container">
			<div class="row">
				<p class="tm-copyright-text">Copyright &copy; 2021 Sishan Maharjan 
